...
\begin{titlepage}
 ...
 \begin{minipage}{\textwidth}
  ...
  {\Huge\bfseries Guión de prácticas\\}
 \end{minipage}
...
\begin{enumerate}
  ...
  \end{solution}
	...
	\begin{solution}
		\textit{EXT4}, a diferencia de \textit{EXT2}, admite \textit{journaling}, es decir, un diario que permite restablecer los datos anteriores a una transacción en caso de que esta falle. Esta técnica permite al sistema de archivos volver a un estado coherente si se produce un corte de electricidad o cualquier otro fallo durante una transacción.
	\end{solution}
\end{enumerate}

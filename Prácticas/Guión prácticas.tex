...
Esta utilidad nos permite realizar peticiones de datos de monitorización de una máquina a la otra. Para instalarlo, ejecutamos la siguiente orden:
\begin{lstlisting}
Ubuntu $> sudo apt install -y zabbix-get
CentOS #> yum install -y zabbix-get.x86_64
\end{lstlisting}
...
CentOS $> zabbix_get -s 192.168.56.105 -k net.tcp.service[ssh,,22022]
Ubuntu $> zabbix_get -s 192.168.56.105 -k net.tcp.service[http]
\end{lstlisting}
